...
//share
export function OutlineShare(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
//save
export function OutlineSaveAll(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
    ...
    >
      <path
        fill="currentColor"
        d="M17 6H8a2 2 0 0 0-2 2v11a2 2 0 0 0 2 2h11c1.1 0 2-.9 2-2v-9zm2 13H8V8h8.17L19 10.83z"
      ></path>
      <path fill="currentColor" d="M9 9h6v2H9z"></path>
      <circle cx="13.5" cy="15.5" r="2.5" fill="currentColor"></circle>
...
//LeftBar svgs
//design
export function DesignIdeas16Regular(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 16 16"
...
export function ColorCard(props) {
  return (
    ...
    >
      ...
      <g fill="none">
        <path d="M10 44a6 6 0 0 0 6-6V4H4v34a6 6 0 0 0 6 6"></path>
        <path
          stroke="currentColor"
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeWidth="4"
          d="M10 44a6 6 0 0 0 6-6V23.515M10 44a6 6 0 0 1-6-6V4h12v19.515M10 44h34V32H24.485M5.757 42.243a6 6 0 0 0 8.486 0L24.485 32M16 23.515L35.015 4.5l.47-.5l8.5 8.5l-19.5 19.5"
        ></path>
        <path
          stroke="currentColor"
          strokeLinecap="round"
          strokeLinejoin="round"
          strokeWidth="4"
          d="M14.243 42.243L43.985 12.5l-8.5-8.5L16 23.515"
        ></path>
        <use
          href="#ipOColorCard0"
          strokeLinecap="round"
        ...
        <path
          ...
          strokeLinejoin="round"
          strokeWidth="4"
          d="M10 44a6 6 0 0 0 6-6V4H4v34a6 6 0 0 0 6 6"
        ></path>
      </g>
    </svg>
  );
...
//sticker
export function EmojiStickerLine(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
//logo
export function Logout2Broken(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
  ...
  return (
    ...
    >
      <g
        ...
        strokeWidth="1.5"
      >
        <path d="m10.25 4.75l-3.5 3.5l3.5 3.5"></path>
  ...
  return (
    ...
    >
      <g
        ...
        strokeWidth="1.5"
      >
        <path d="m13.25 4.75l3.5 3.5l-3.5 3.5"></path>
...
//pagination arrows forward
export function BaselineKeyboardArrowRight(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function BaselineKeyboardArrowLeft(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
//item settings item lock
export function OutlineLock(props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function HorizontalCenter(props) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="m5.005 15.995l4-4l-4-4v3h-3v2h3zm14-5v-3l-4 4l4 4v-3h3v-2h-2.072zm-8 7h2v3h-2zm0-5h2v3h-2zm0-5h2v3h-2zm0-5h2v3h-2z"
      ></path>
    </svg>
  );
}

//item setting centerize item y
export function VerticalCenter(props) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M13 5V2h-2v3H8l4 4l4-4zm0 17v-3h3l-4-4l-4 4h3v3zM3 11h3v2H3zm5 0h3v2H8zm5 0h3v2h-3zm5 0h3v2h-3z"
      ></path>
    </svg>
  );
}
